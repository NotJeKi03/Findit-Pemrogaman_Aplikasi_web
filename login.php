    ...
    <div class="flex justify-center bg-gray-50 min-h-screen mt-50">
        ...
        <div
            ...
            <div class="login-box">
                ...
                <form action="model/login.php" method="POST" class="flex flex-col gap-4">
                    <p class="font-semibold">Email Address</p>
                    <input id="email" type="email" name="email" placeholder="Enter your email" class="input-style"
                        required />
                    ...
                    <div class="relative">
                        <input id="password" type="password" name="password" placeholder="Enter your password"
                            class="input-style w-full" required />
